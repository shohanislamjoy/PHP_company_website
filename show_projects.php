...
?>
        <div class="col-lg-6 mb-4">
            <div class="card h-100"> <!-- Add the 'h-100' class to ensure consistent card height -->
                ...
                <div class="card-body ">
                    ...
                    <div class="text-center">
                        <a href="<?php echo $row['website_link']; ?>" class="btn btn-primary button-89">Visit Website</a>
                    </div>
                </div>
            </div>
        </div>
